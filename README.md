...
The objective of this assignment is to learn the Probability Density Function (PDF) of a transformed random variable derived from real-world NO₂ concentration data. The transformation and PDF parameters are uniquely determined using the student’s roll number.
